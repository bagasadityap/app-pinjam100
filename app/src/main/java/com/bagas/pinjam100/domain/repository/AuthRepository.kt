...
interface AuthRepository {
    ...
    suspend fun register(data: RegisterData): AppResult<Unit>
    suspend fun verifyOtp(data: VerifyOtpData): AppResult<AuthSession>
    suspend fun resendOtp(data: ResendOtpData): AppResult<Unit>
    suspend fun forgotPassword(data: ForgotPasswordData): AppResult<Unit>
    suspend fun resetPassword(data: ResetPasswordData): AppResult<Unit>
    suspend fun changePassword(data: ChangePasswordData): AppResult<Unit>
